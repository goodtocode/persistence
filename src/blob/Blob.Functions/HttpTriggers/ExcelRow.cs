...
namespace GoodToCode.Shared.Blob.Excel
{
    public class ExcelRow
    {
        ...
        public const string FunctionName = "ExcelRow";

        private readonly IFileValidationService _fileValidator;
        private readonly ExcelService _fileReader;

        public ExcelRow(ILogger<ExcelRow> logger, IConfiguration config, IFileValidationService fileValidator, ExcelService fileService)
        {
            log = logger;
